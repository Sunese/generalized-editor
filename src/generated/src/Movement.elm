...
toCCtx_cond : Syntax.Base.Cond -> List Int -> ( Syntax.CCtx.Cctx, Syntax.Base.Base )
...
decompose : Syntax.Base.Base -> ( Syntax.CCtx.Cctx, Syntax.Wellformed.Wellformed )
decompose base =
    let
        ( cctx, rest ) =
...
replaceCctxHole : Int -> Syntax.CCtx.Cctx -> Syntax.Cursorless.CursorLess -> Syntax.CCtx.Cctx
...
moveCCtxHoleUp : Syntax.CCtx.Cctx -> List Int -> Maybe ( Syntax.CCtx.Cctx, Syntax.CCtx.Cctx )
