...
type Fd_CLess
    = Fundecl1_CLess T_CLess (Syntax.Bind.Bind Id_CLess Fd_CLess) T_CLess (Syntax.Bind.Bind Id_CLess B_CLess)
    | Fundecl2_CLess T_CLess (Syntax.Bind.Bind Id_CLess Fd_CLess) T_CLess T_CLess (Syntax.Bind.Bind Id_CLess B_CLess)
    | Fundecldone_CLess
    | Hole_fd_CLess
